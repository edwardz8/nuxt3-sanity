        ...
        <div class="mx-auto max-w-7xl">
            <div class="relative z-10 bg-white pb-8 sm:pb-16 md:pb-20 lg:w-full lg:max-w-2xl lg:pb-28 xl:pb-32">
                    ...
                    <transition enter-active-class="duration-150 ease-out" enter-from-class="opacity-0 scale-95"
                        ...
                        <PopoverPanel focus
                            ...
                            <div class="overflow-hidden rounded-lg bg-white shadow-md ring-1 ring-black ring-opacity-5">
                                ...
                                <a href="#"
                                    class="block w-full bg-gray-50 px-5 py-3 text-center font-medium text-orange-600 hover:bg-gray-100">Log
                                    in</a>
                            </div>
                        </PopoverPanel>
                    </transition>
                ...
                <main class="mx-auto mt-10 max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                  ...
                  <a href="#" class="flex w-full items-center justify-center rounded-md border border-transparent bg-orange-100 px-8 py-3 text-base font-medium text-orange-700 hover:bg-orange-200 md:py-4 md:px-10 md:text-lg">Live demo</a>
                </div> -->
                        </div>
                    </div>
                </main>
